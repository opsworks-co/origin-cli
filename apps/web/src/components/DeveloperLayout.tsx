    ...
    <div className="flex h-screen overflow-hidden bg-gray-950">
      ...
      >
        ...
        <div className="flex items-center gap-3 px-5 h-[60px] border-b border-white/[0.06]">
          ...
          <div>
            <span className="text-[15px] font-semibold text-gray-100 tracking-tight">Origin Solo</span>
          </div>
          <button
            onClick={() => setSidebarOpen(false)}
        ...
        <div className="border-t border-white/[0.06] px-3 py-3">
          <div className="flex items-center gap-3 px-2 py-2">
            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-emerald-500/20 to-emerald-600/20 ring-1 ring-emerald-500/20 flex items-center justify-center text-emerald-400 text-sm font-medium">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="lg:hidden flex items-center gap-3 px-4 h-[52px] border-b border-white/[0.06] bg-gray-900/80 backdrop-blur-xl">
          ...
          <span className="text-xs text-emerald-500/80">Solo</span>
        </header>
