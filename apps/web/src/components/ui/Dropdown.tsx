  ...
  return (
    <div ref={rootRef} className={`relative inline-block ${className}`}>
      ...
      {open && (
        <div
          role="menu"
          className={`absolute top-full mt-1 min-w-[180px] rounded-lg border border-gray-800 bg-gray-900 shadow-xl py-1 z-50 ${
        ...
        >
          {items.map((item, i) => {
            ...
            const common = 'w-full text-left flex items-center gap-2 px-3 py-2 text-xs transition-colors';
