...
export default function Login() {
  ...
  // Show only the OAuth providers the server can actually use. Without
  // this, users see (e.g.) a Google button that errors with "Google OAuth
  // not available" the moment they click it, because GOOGLE_CLIENT_ID
  // isn't set on the deployment. Defaults to all-enabled while the
  // request is in flight so the buttons aren't briefly missing.
