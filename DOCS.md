...
Origin is an AI coding governance platform that tracks, attributes, and governs AI-assisted code across your team. The CLI hooks into AI coding agents (Claude Code, Cursor, Codex, Gemini CLI; Antigravity/Windsurf/Aider are experimental) to capture session data, enforce policies, and provide attribution analytics.
