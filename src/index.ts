...
program.command('verify-capture')
  ...
  .option('--since <when>', 'Only sessions started since an ISO date or <N>d (e.g. 7d); invalid values exit 3')
...
program.command('clean')
  ...
  .option('--shadow-refs', 'Only clean unreferenced Origin shadow refs older than 30 days')
